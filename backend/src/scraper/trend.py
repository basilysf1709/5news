...
common_english_words = set(['after', '5', 'over', 's', 'amid', 'the', 'of', 'in', 'and', 'to', 'a', 'is', 'on', 'for', 'with', 'at', 'by', 'from'])
...
with open('keyword_trends.json', 'w') as json_file:
